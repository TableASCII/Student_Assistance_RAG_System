...
Система помогает студентам быстро находить ответы на вопросы, связанные с учебой. В качестве базы данных используется ["Путеводитель первокурсника" НГТУ им. Алексеева](./data/Putevoditel_pervokursnika_NNTU.pdf).  
